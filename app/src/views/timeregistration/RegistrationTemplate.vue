          ...
          <div class="col-lg-12 col-sm-12 specialized-box">
            ...
            <div class="cell">
              <bue-field class="label" label="Start time">
                <bue-clockpicker placeholder="Type or select a date..." icon-pack="fa" icon="clock-o" hour-format="24" :readonly="false" v-model="form.startTime" editable :native-mobile="false">
            ...
            <div class="cell">
              <bue-field class="label" label="End time">
                <bue-clockpicker placeholder="Type or select a date..." icon-pack="fa" icon="clock-o"  hour-format="24" :readonly="false" v-model="form.endTime" mobile-native editable>
