    ...
    <b-row>
      <b-col md="12">
        <b-card header="Traffic &amp; Sales">
          ...
          <b-table class="mb-0 table-outline" responsive="sm" hover :items="workers" :fields="tableFields" head-variant="light">
            ...
            <div slot="photoURL" slot-scope="item">
              <div><b-img width=70 src="https://picsum.photos/250/250/?image=54" rounded="circle" thumbnail  >{{item.value}}</b-img></div>
            </div>
...
export default {
  ...
  mounted(){
    this.workers = firestoreHandler.getAllWorkers()
